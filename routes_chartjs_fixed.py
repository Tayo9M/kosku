...
Endpoint diberi nama berbeda untuk menghindari konflik dengan routes.py.
"""
...
@app.route('/room_stats_js')
@login_required
def room_stats_js():
    """Versi Chart.js dari fungsi statistik kamar"""
...
@app.route('/financial_stats_js')
@login_required
def financial_stats_js():
    """Versi Chart.js dari fungsi statistik keuangan"""
